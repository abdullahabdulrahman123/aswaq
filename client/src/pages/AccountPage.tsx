 ...
 * لأنه حاجة تخص أسواق مش منصة الهوية.
 */
      ...
      <section className="mt-6 rounded-2xl border border-stone-200 bg-white p-5 dark:border-white/10 dark:bg-surface-card">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="min-w-0">
            ...
            <div className="mt-2 inline-block rounded-md bg-stone-100 px-2 py-0.5 text-xs font-medium dark:bg-white/10">
              {business ? 'حساب شركة' : 'حساب فرد'}
            </div>
          </div>
        ...
        {business ? (
          <>
            ...
            <p className="mt-4 rounded-lg bg-stone-50 px-3 py-2.5 text-sm leading-relaxed text-stone-600 dark:bg-white/5 dark:text-stone-300">
              ...
              <span className="text-stone-400">
                رفع منتجاتك وإدارة مخزونك هيتضافوا في مرحلة جاية.
              </span>
            </p>
          ...
          <>
            <p className="mt-2 leading-relaxed text-stone-600 dark:text-stone-300">
              عندك شركة أو محل وعايز تبيع على أسواق؟ سجّل نشاطك التجاري وحسابك
              هيتحوّل لحساب شركة — تشوف أسعار الكميات، ويبقى ليك سوقك الخاص.
            </p>

            <button
              onClick={() => setPendingNote(true)}
              className="mt-4 rounded-xl bg-brand-500 px-5 py-3 text-sm font-semibold text-white transition hover:bg-brand-600"
            >
              أنشئ نشاط تجاري
            </button>
